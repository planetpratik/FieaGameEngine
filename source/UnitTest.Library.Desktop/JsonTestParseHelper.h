...
namespace UnitTestLibraryDesktop
{
	...
	public:
		...
		virtual bool JsonTestParseHelper::startHandler(FieaGameEngine::JsonParseMaster::SharedData& t_shared_data, const std::string& t_key, Json::Value& t_values) override;
